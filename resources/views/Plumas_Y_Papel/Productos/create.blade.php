                                ...
                                <div class="col-sm-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="nombre_producto" type="text" id="nombre_producto" class="form-control" value="{{ old('nombre_producto') }}">
                                ...
                                <div class="col-sm-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="descripcion_producto" type="text" id="descripcion_producto" class="form-control" value="{{ old('descripcion_producto') }}">
                                ...
                                <div class="col-sm-12 mb-3">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="stock_producto" type="number" id="stock_producto" class="form-control" value="{{ old('stock_producto') }}">
