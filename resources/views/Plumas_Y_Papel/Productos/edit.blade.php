                    ...
                    @method('PUT')
                                        ...
                                        <div class="picture-container">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                    @if ($imagenes->isNotEmpty() && $imagenes->firstWhere('t080_is_cover', 1))
                                                        <img src="{{ asset($imagenes->firstWhere('t080_is_cover', 1)->t080_url) }}" alt="Imagen del producto">
                                                    @else
                                                        <img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
                                                    @endif
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <!-- Aquí enviamos el ID si existe -->
                                                    <input type="hidden" name="img_ids[img_1]"
                                                        value="{{ $imagenes->firstWhere('t080_is_cover', 1)->t080_rowid ?? '' }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-sm-offset-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="t100_name_product" id="t100_name_product" class="form-control" value="{{$producto->t100_name_product}}">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="t100_stock_product" id="t100_stock_product" class="form-control" value="{{$producto->t100_stock_product}}">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group label-floating">
                                            ...
                                            <select name="t100_status_product" class="form-control">
                                            <option value="1" {{ old('t100_status_product', $producto->t100_status_product) == 1 ? 'selected' : '' }}>Listado</option>
                                            <option value="0" {{ old('t100_status_product', $producto->t100_status_product) == 0 ? 'selected' : '' }}>No Listado</option>
                                        </select>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="picture-container">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                @if ($imagenes->isNotEmpty() && isset($imagenes[1]))
                                                        <img src="{{ asset($imagenes[1]->t080_url) }}" alt="Imagen del producto">
                                                    @else
                                                        <img src="{{asset('assets/img/image_placeholder.jpg')}}" alt="Imagen por defecto">
                                                    @endif
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <!-- Aquí enviamos el ID si existe -->
                                                    <input type="hidden" name="img_ids[img_2]" value="{{ $imagenes[1]->t080_rowid ?? '' }}">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="picture-container">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                @if ($imagenes->isNotEmpty() && isset($imagenes[2]))
                                                        <img src="{{ asset($imagenes[2]->t080_url) }}" alt="Imagen del producto">
                                                    @else
                                                        <img src="{{asset('assets/img/image_placeholder.jpg')}}" alt="Imagen por defecto">
                                                    @endif
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <!-- Aquí enviamos el ID si existe -->
                                                    <input type="hidden" name="img_ids[img_3]" value="{{ $imagenes[2]->t080_rowid ?? '' }}">
                                                    <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="picture-container">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                @if ($imagenes->isNotEmpty() && isset($imagenes[3]))
                                                        <img src="{{ asset($imagenes[3]->t080_url) }}" alt="Imagen del producto">
                                                    @else
                                                        <img src="{{asset('assets/img/image_placeholder.jpg')}}" alt="Imagen por defecto">
                                                    @endif
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="hidden" name="img_ids[img_4]" value="{{ $imagenes[3]->t080_rowid ?? '' }}">
                                                    <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="picture-container">
                                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail">
                                                @if ($imagenes->isNotEmpty() && isset($imagenes[4]))
                                                    <img src="{{ asset($imagenes[4]->t080_url) }}" alt="Imagen del producto">
                                                @else
                                                    <img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
                                                @endif
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="hidden" name="img_ids[img_5]" value="{{ $imagenes[4]->t080_rowid ?? '' }}">
                                                    <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <textarea class="form-control"  name="t100_desc_product" id="t100_desc_product"  rows="4">{{$producto->t100_desc_product}}</textarea>
                            ...
                            <div class="tab-pane" id="address">
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        ...
                                        <input type="hidden" name="t100_publishing_policies" value="{{ $producto->t100_publishing_policies }}">

                                        <!-- Checkbox solo para mostrar, deshabilitado -->
                                        <input type="checkbox" disabled
                                            {{ old('t100_publishing_policies', $producto->t100_publishing_policies) === 'on' ? 'checked' : '' }}>
                                        <label for="t100_publishing_policies">Aceptar</label>
                        ...
                        <div class="wizard-footer">
                            <div class="pull-right">
                                ...
                                <input type='submit' class='btn btn-finish btn-fill btn-rose btn-wd' value="Actualizar"/>
                            </div>
                            <div class="pull-left">
