										...
										<div class="picture-container">
											<div class="fileinput fileinput-new text-center" data-provides="fileinput">
												...
												<div>
													...
													<input type="hidden" name="img_ids[img_1]" value="{{ $imagenes->firstWhere('t080_is_cover', 1)->t080_rowid ?? '' }}">
								...
								<div class="row">
									...
									<div class="col-sm-4 col-sm-offset-1">
										<div class="picture-container">
											<div class="fileinput fileinput-new text-center" data-provides="fileinput">
												<div class="fileinput-new thumbnail">
													@if ($img = $imagenes->where('t080_is_cover', '!=', 1)->values()->get(0))
													<img src="{{ asset($img->t080_url) }}" alt="Imagen del producto">
													@else
													<img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
													@endif
												</div>
												...
												<div>
													...
													<input type="hidden" name="img_ids[img_2]" value="{{ $img?->t080_rowid ?? '' }}">
													<a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput">
														<i class="fa fa-times"></i> Remove
													</a>
												</div>
									...
									<div class="col-sm-4 col-sm-offset-1">
										<div class="picture-container">
											<div class="fileinput fileinput-new text-center" data-provides="fileinput">
												<div class="fileinput-new thumbnail">
													@if ($img = $imagenes->where('t080_is_cover', '!=', 1)->values()->get(1))
													<img src="{{ asset($img->t080_url) }}" alt="Imagen del producto">
													@else
													<img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
													@endif
												...
												<div>
													...
													<input type="hidden" name="img_ids[img_3]" value="{{ $img?->t080_rowid ?? '' }}">
													<a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput">
														<i class="fa fa-times"></i> Remove
													</a>
												</div>
									...
									<div class="col-sm-4 col-sm-offset-1">
										<div class="picture-container">
											<div class="fileinput fileinput-new text-center" data-provides="fileinput">
												<div class="fileinput-new thumbnail">
													@if ($img = $imagenes->where('t080_is_cover', '!=', 1)->values()->get(2))
													<img src="{{ asset($img->t080_url) }}" alt="Imagen del producto">
													@else
													<img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
													@endif
												...
												<div>
													...
													<input type="hidden" name="img_ids[img_4]" value="{{ $img?->t080_rowid ?? '' }}">
													<a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput">
														<i class="fa fa-times"></i> Remove
													</a>
												</div>
									...
									<div class="col-sm-4 col-sm-offset-1">
										<div class="picture-container">
											<div class="fileinput fileinput-new text-center" data-provides="fileinput">
												<div class="fileinput-new thumbnail">
													@if ($img = $imagenes->where('t080_is_cover', '!=', 1)->values()->get(3))
													<img src="{{ asset($img->t080_url) }}" alt="Imagen del producto">
													@else
													<img src="{{ asset('assets/img/image_placeholder.jpg') }}" alt="Imagen por defecto">
													@endif
												...
												<div>
													...
													<input type="hidden" name="img_ids[img_5]" value="{{ $img?->t080_rowid ?? '' }}">
													<a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput">
														<i class="fa fa-times"></i> Remove
													</a>
												</div>
