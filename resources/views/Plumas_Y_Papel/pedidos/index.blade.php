          ...
          <div class="card-content">
            ...
            <div class="info-general">
              ...
              <div class="botnes-pedidos mt-3 mb-4">
                <a href="{{ route('Pedidos.index') }}" class="btn btn-next btn-fill btn-rose btn-wd">Pedidos activos</a>
                <a href="#" class="btn btn-next btn-fill btn-rose btn-wd">Pedidos antiguos</a>
              </div>
